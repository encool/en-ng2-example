    ...
    template: `
        <my-div [classes]="'container-viewer'" [hidden]="completed" [styles]="'padding: 10px 15mm; max-width:180mm;background: #fff; border: 2px solid #dadada; box-shadow: 0 0 10px #d0d0d0;'">
            <my-div span=12 [hidden]="global.handleinline">
                ...
                <button md-button *ngIf="!isstart" class="btn btn-primary" (click)="processMonitor()">流程监控</button>                
            </my-div>
            <dynamic-form-m *ngIf="!isCustomForm" [fields]="fields" ></dynamic-form-m>
...
export class UsertaskDoComponent implements OnInit {
    ...
    @ViewChild(DynamicFormMComponent) formCom: DynamicFormMComponent;
    ...
    static toWfFormGroupField(fields: any[], permissiondata: any, params: any, webDisplayTypes: any): any[] {
        // debugger
        ...
        fields.forEach(field => {
            switch (field.webDisplayTypeId) {
                ...
                //     break
                // case "f-text-input":
                //     newFields.push(new TextInputComponent({
                ...
                default:
                    newFields.push(new CustomTemplateField({
                        // selector: field.webDisplayTypeId,
                        selector: webDisplayTypes[field.webDisplayTypeId].mobileUrl || webDisplayTypes[field.webDisplayTypeId].url,
                        key: field.fieldNo,
                        type: field.fieldType == 'INT' ? 'number' : null,
                        label: field.displayName || field.fieldId.fieldName,
                        labelWidth: field.labelWidth,
